/**
 * 统一 e2e 入口：依次跑六组验收脚本（真 Chromium + 真 IndexedDB，只 stub 相机与生图接口）。
...
const scripts = [
  ...
  ['拍照三环境与能力约束（42 项：三环境 / 降级不锁死 / 相机诊断 / 重新检测）', 'acceptance-capture.e2e.mjs'],
  ['AI 默认 Base 真浏览器生效（10 项）', 'acceptance-ai-base.e2e.mjs'],
];
