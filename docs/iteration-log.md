...
| `web/` | **v0.8** | React 19 + TS 严格 + Vite + Tailwind + Zustand | <https://tomorrowdolol.github.io/snapsaga-trip-prototype/web/> |

<!-- check-docs: root-version=v0.6 web-version=v0.8 —— 上面两个版本号由 scripts/check-docs.mjs 与页头比对 -->
...
- **验证矩阵**（在 `web/` 跑 `npm run verify`）：149 个单测 · 139 项 e2e · 93 项 guard；分层说明见 [`../web/README.md`](../web/README.md)。
